...
#updated ~ weekly.
casedata<-vroom("https://data.humdata.org/dataset/f5c35452-d766-468a-a272-4bd82d0a3be0/resource/15b9978f-422b-4b3d-9513-359b520d8352/download/nga_subnational_covid19_hera.csv",sep=";")
...
Nigeriadf = inner_join(caseTable,Population, by = c("regions"="Name"))
...
MapNigeria$RegionName = paste(MapNigeria$admin1Name, MapNigeria$country_name, sep = ", ")
