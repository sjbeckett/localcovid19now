...
geomNetherlands$Code <- paste0("GM",geomNetherlands$Code)
geomNetherlands$Gemeentenaam <- NULL
geomNetherlands$gml_id <- NULL
# netherlandsMap <- inner_join(geomNetherlands, netherlandsTable, by = c("Gemeentecode" = "Code"))
netherlandsMap <- inner_join(geomNetherlands, netherlandsTable, by = "Code")
