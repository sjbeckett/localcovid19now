...
NAME = c("ACEH","BALI","BANTEN","BENGKULU","DAERAH ISTIMEWA YOGYAKARTA","DKI JAKARTA","GORONTALO","JAMBI", "JAWA BARAT","JAWA TENGAH", "JAWA TIMUR","KALIMANTAN BARAT",
...
pop = c(5274871,4317404, 11904562, 2010670 , 3668719, 10562088 ,1171681 , 3548228 , 48274162 , 36516035, 40665696, 5414390, 
