LoadSmallCountries <- function() {
  ...
  # Geography
  data("geomSmallCountries") # from world bank https://datacatalog.worldbank.org/dataset/world-bank-official-boundaries
  data("pop_smallcountries")
  geomSmallCountries <- inner_join(geomSmallCountries, pop_smallcountries, by = c("country_name" = "NAME_EN"))
  ...
  # integrate datasets
  MapGL <- inner_join(geomSmallCountries, caseTable, by = c("country_name" = "CountryList"))
