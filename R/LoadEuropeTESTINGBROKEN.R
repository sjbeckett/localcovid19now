...
#' @examples
#' \dontrun{
#' Europe3 <- LoadEuropeTESTINGBROKEN()
#' }
#' @seealso [LoadCountries()]
#' @export
LoadEuropeTESTINGBROKEN <- function(tidy = TRUE, DaysOld = 30, minimumpercapitaactivecases = 0, RiskEval = NULL, dropNACountry = FALSE, dropNAall = FALSE) {
  ...
  tryCatch({
    ...
    EUWHO <- vroom::vroom("https://arcgis.com/sharing/rest/content/items/54d73d4fd4d94a0c8a9651bc4cd59be0/data22222who", col_types = c(DateRpt = "c"), show_col_types = FALSE, progress = FALSE)
    ...
    return(EUROPE_DATA)
  }, warning = function(w){LoadErrorWarning("LoadEuropeTESTINGBROKEN")}
